        ...
        public static void Main(string[] args)
        {
            ...
            using (var scope = host.Services.CreateScope())
            {
                ...
                if (!app.Value.SeedData)
                {
                    ...
                    {
                        userMgr.CreateAsync(new AppUser { UserName = "admin", Email = "admin@wzu.edu.cn" }, "admin").Wait();
                        userMgr.CreateAsync(new AppUser { UserName = "demo", Email = "demo@wzu.cn" }, "demo").Wait();
                    }
